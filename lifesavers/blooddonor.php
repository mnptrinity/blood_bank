...
$result = mysqli_query($con,"SELECT * FROM blood_donor where mailid = '$g'");
...
<div id="card" class="hover14 column">
  ...
  <p><b>District</b>&nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row["district"]; ?></p>
	<p><b>Contact</b>&nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row["mob1"]; ?> </p>
	<p><b>Availability</b>&nbsp; &nbsp; &nbsp; &nbsp;<?php echo $row["Available"]; ?> </p>
	<br/>
	<?php 
	...
	&nbsp; &nbsp; &nbsp; &nbsp; 
	<a href="http://localhost/lifesavers/editblood.php"><img src="images/edit.png" height="100" width="100"></img></a>
	<br/>
	<p>    </p>
	<br/>
	<p>    </p>
