...
<center><div class="home_title"><h1>Blood Donor List</h1></div></center>
	</header>
						...
						<div class="container">
							...
							<div class="row">
								<div class="col">
                                        ...
                                        $s = " select name,age,mob1,mailid,district,bloodgroup from blood_donor ";
										$result = $con->query($s);
										...
										{
                                         echo "<tr><td>".$row["name"]."</td><td>".$row["age"]."</td><td>".$row["mob1"]."</td><td>".$row["mailid"]."</td><td>".$row["district"]."</td><td>".$row["bloodgroup"]."</td></tr>";
										}
										echo "</table>";
										}
										else
