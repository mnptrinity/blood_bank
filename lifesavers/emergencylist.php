					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<nav class="main_nav ml-auto">
								...
								<ul>
									<li><a href="http://localhost/lifesavers/emergency.html" style="font-size:20px">Home</a></li>
						...
						<div class="container">
							...
							<div class="row">
								<div class="col">
										...
										$aadhar =$_POST['aadhar'];
                                        $s = " select name,age,mob1,mob2,mob3 from emergency_call where aadhar = '$aadhar'  ";
										$result = $con->query($s);
										...
										{
                                         echo "<tr><td>".$row["name"]."</td><td>".$row["age"]."</td><td>".$row["mob1"]."</td><td>".$row["mob2"]."</td><td>".$row["mob3"]."</td></tr>";
										}
										echo "</table>";
										}
										else
