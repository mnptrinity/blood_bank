...
<h2 style="text-align:center">Recipient card</h2>
<form>
<?php
session_start();
...
$result = mysqli_query($con,"SELECT * FROM organ_recipient where mailid = '$g'");
...
<div id="card" class="hover14 column">
  ...
  <p><b>District</b>&nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row["district"]; ?></p>
	...
	&nbsp; &nbsp; &nbsp; &nbsp; 
	<a href="http://localhost/lifesavers/editorganrecipient.php"><img src="images/edit.png" height="100" width="100"></img></a>
	<br/>
	<p>    </p>
	<br/>
	<p>    </p>
